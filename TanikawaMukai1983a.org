...
#+ROAM_KEY: cite:TanikawaMukai1983a
#+ROAM_TAGS: article
...
*** Model :lightSkyblue:
- opitimization, [[file:20200512110355-large_scale_systems.org][large scale systems]], non-convex separable , equaltity constraints
*** Remarks
*** Applications
*** Expressions
*** References :violet:
