...
#+ROAM_TAGS: article
- tags :: [[file:20200504163253-recursive_least_squares.org][recursive least-squares]], [[file:20200504163319-identification.org][identification]], [[file:20200504162654-adaptive_control.org][adaptive control]],[[file:20200422140353-estimation.org][ Parameter Estimation]]
...
$\bar{\mathcal{E}}=\{x\in\mathbb{R}^n| \existsL<\infty:x'\sum\limits^N_1 \phi(t)\phi(t)'x<L,\forall N\}$
